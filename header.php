            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="images/chander_mohan.jpg" alt="..." class="img-circle profile_img">
                    </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="blocks.php"><i class="fa fa-edit"></i> Blocks </a></li>
                            ...
                            <li><a href="checkAttendance.php"><i class="fa fa-edit"></i>Check Attendance of particular Class </a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="images/chander_mohan.jpg" alt=""><?php echo $_SESSION['email']; ?>
