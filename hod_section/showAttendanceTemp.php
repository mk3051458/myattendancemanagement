...
<?php  	 
    ...
    include "header.php";
	$qq="select * from hods where email='$_SESSION[email]'";
	$rr=mysqli_query($con,$qq);
	$ro=mysqli_fetch_array($rr);
	$chart=0;
	$q1="select * from classes where block_id='$ro[block_id]' and department_id='$ro[department_id]' ";
	                    ...
	                    <div class="x_content" style="overflow:auto;height:auto">      
							...
							while($row2=mysqli_fetch_array($res2)){	
								...
								while($row3=mysqli_fetch_array($res3)){
						            ...
						            $qu2="select attendance from tutorialattendance where class_id='$row1[class_id]' and subject_code='$row2[subject_code](T)' and groupNo='$group' or class_id='$row1[class_id]' and subject_code='$row2[subject_code](t)' and groupNo='$group'or class_id='$row1[class_id]' and subject_code='$row2[subject_code]' and groupNo='$group'";
