...
?>
    ...
    <script type="text/javascript">
        ...
        function check(){
            var a=document.getElementById("current_password").value;
            if(a==""){
            ...
            var c=document,getElementById("re_enter_new_password").value;
            if(c==""){
                ...
                <form class="form-horizontal form-label-left" method="post" action="changePasswordIndb.php"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-offset-3 col-xs-10">
                                    <button type="submit" name="submit" class="btn btn-primary" onclick="return check()">Change Password</button>
                        </div>
                    </div>
