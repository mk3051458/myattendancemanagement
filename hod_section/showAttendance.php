                ...
                <div class="row">
                    <div class="x_content">
                    	<form action="showDetainList.php?class=<?php echo $_REQUEST['class'];?>" method="POST"> 
	                    			<input type="submit" value="Show detain list" class="btn btn-primary" name="submit"> 
	                    			<a href="createPdf.php?class=<?php echo $_REQUEST['class'] ?>" class="btn btn-primary">Download PDF</a>
	                    		</form>
