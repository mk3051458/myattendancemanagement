  ...
  <body class="login" >
    <nav class="navbar d-print fixed-top navbar-inverse" style="border-radius: 1px; box-shadow: 0 2px 5px rgba(255,255,255); ">
        ...
        <span class="nav navbar-nav navbar-right" style="padding-top: 5px">
            ...
            <a href="index.php" class="navbar-brand vis"style="font-family: 'Roboto', sans-serif;padding-right: 0px"> HOD's Corner</a>
            ...
            <div id="mySidenav" class="sidenav visi">
                ...
                <a href="index.php" style="font-family: 'Roboto', sans-serif;color: white"> HOD's Corner</a>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="index.php" style="font-family: 'Roboto', sans-serif;color: black"> HOD's Corner</a>
    ...
    <div class="row text-center" style="font-family: 'Roboto', sans-serif;color:white;height:40px;background:rgba(34,34,34,0.8);"><h4>HOD Section</h4></div>
    <div
    <div>
        ...
        <div class="animate form login_form">
          <section class="login_content">
             <?php 
                ...
                ?>
            <form method="post" name="login" action="check_for_hod.php" autocomplete="on">
              <h1>Login Please</h1>
              <div>
